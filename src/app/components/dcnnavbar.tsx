...
export default function DcnNavBar() {
    ...
    return (
        ...
        >
            ...
            <ul className="flex space-x-6 border-1 border-white py-2 px-4 rounded-xl bg-blue-950">
            ...
            {address && <p className="text-white-700 text-lg font-semibold">Connected: {address}</p>}
            {!isConnected && (
                <appkit-button />
            )} */}
