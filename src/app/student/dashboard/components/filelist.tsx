...
const FileList: FC = () => {
    ...
    return (
        <div className="text-gray-900 rounded-lg p-4">
            <div className="flex justify-between px-6 pb-4 border-b border-gray-400 text-gray-300">
            ...
            <div className="">
                {files.map((file, index) => (
                    <div key={index} className="flex items-center p-5 py-7 bg-[#0A0B1E] my-2 hover:bg-gray-250 rounded-xl">
