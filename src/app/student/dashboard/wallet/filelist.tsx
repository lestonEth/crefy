        ...
        <div className="text-gray-900 rounded-lg p-4">
            ...
            <div className="flex justify-end items-center pt-4 text-gray-700 gap-[20%]">
                <div className="flex items-center space-x-2">
                    ...
                    <select className="bg-[#0095FF] border-none rounded text-gray-300 py-2 px-5 focus:outline-none">
                        <option>10</option>
                        <option>20</option>
                        <option>30</option>
                    </select>
                </div>
                <div className="flex items-center space-x-4 px-4 font-bold text-xl text-gray-300">
                    <button>{'<'}</button>
                    <button>{'>'}</button>
                </div>
            </div>
